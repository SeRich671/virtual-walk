                ...
                <form action="{{ route('project.update', $project) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="description" id="description" rows="4"
                                  class="mt-1 block w-full rounded-md shadow-sm border-gray-300 focus:ring-blue-500 focus:border-blue-500">{{ old('description', $project->description) }}</textarea>
                        @error('description')
                        <p class="text-red-500 text-sm mt-2">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="mb-4">
                        <p>Code Snippet</p>
                        <p>
                            {{ '<iframe src="' . route('project.show', $project->share_url) . '" frameborder="0" width="600" height="400"></iframe>' }}
                        </p>
                    </div>
